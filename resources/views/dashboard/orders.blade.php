...
@section('body')
    ...
    <div class="container-fluid py-4 medical-orders-page">
        <div class="medical-page-header mb-4">
            <div>
                <h2 class="medical-title mb-1">
                    <i class="fas fa-file-medical-alt me-2"></i>Order List
                </h2>
                <p class="medical-subtitle mb-0">Track, review, and manage all medical shop orders.</p>
            </div>
