...
@section('body')
    ...
    <div class="container-fluid py-4 medical-reviews-page">
        <div class="medical-page-header mb-4">
            <div>
                <h2 class="medical-title mb-1">
                    <i class="fas fa-star me-2"></i>Customer Reviews
                </h2>
                <p class="medical-subtitle mb-0">Track and review all product and service feedback in one place.</p>
            </div>
            <div class="welcome-chip">
                <i class="fas fa-user-md me-2"></i>{{ Auth::check() ? Auth::user()->name : '' }}
            </div>
        </div>
